...
<template>
    <svg viewBox="0 0 512 512"
        ...
        <path d="M496 479.546H88.278c-13.853 0-25.081-11.23-25.081-25.083v-335.96H496v361.043z"
              fill="#0b3c8f" fill-rule="nonzero"/>
        <path d="M94.276 32.454h345.501c13.853 0 25.083 11.23 25.083 25.083v335.96H94.276V32.454z"
              fill="#1a6afe" fill-rule="nonzero"/>
